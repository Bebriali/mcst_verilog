...
в этой задаче было реализовано два модуля - так как входное число 16-битное, - один из которых вспомогательный и решающий задачу с подаваемым на вход меньшим числом, длиной 4 бита. <br>
